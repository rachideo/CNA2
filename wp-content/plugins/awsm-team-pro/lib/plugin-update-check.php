...
if ( !class_exists('AWSM_Team_Pro_Update_Checker') ):

class AWSM_Team_Pro_Update_Checker {
    ...
    public function requestInfo($queryArgs = array(), $noPlugins = false){
        ...
        if ( !is_wp_error($result) && isset($result['response']['code']) && ($result['response']['code'] == 200) && !empty($result['body']) ){
            $pluginInfo = AWSM_Team_Pro_Plugin_Info::fromJson($result['body'], $this->debugMode);
    ...
    public function requestUpdate(){
        ...
        return AWSM_Team_Pro_Plugin_Update::fromPluginInfo($pluginInfo);
    }
    ...
    public function getUpdateState() {
        ...
        if ( !empty($state) && isset($state->update) && is_object($state->update) ){
            $state->update = AWSM_Team_Pro_Plugin_Update::fromObject($state->update);
        }
        return $state;
    }
...
if ( !class_exists('AWSM_Team_Pro_Plugin_Info') ):
 ...
 * @access public
 */
class AWSM_Team_Pro_Plugin_Info {
...
if ( !class_exists('AWSM_Team_Pro_Plugin_Update') ):
 ...
 * @access public
 */
class AWSM_Team_Pro_Plugin_Update {
    public $id = 0;
    public $slug;
    public $version;
    public $homepage;
    ...
    public static function fromJson($json, $triggerErrors = false){
        ...
        $pluginInfo = AWSM_Team_Pro_Plugin_Info::fromJson($json, $triggerErrors);
        if ( $pluginInfo != null ) {
